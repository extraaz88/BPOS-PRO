...
class _LabelPrinterScreenState extends ConsumerState<LabelPrinterScreen> {
  ...
  Uint8List buildEscPosLabel({
    ...
    required String mix,
    bool addExtraGap = false, // For 0.5mm extra gap between groups
  }) {
  ...
  Future<void> printLabel() async {
    ...
    try {
      ...
      for (int i = 0; i < quantity; i++) {
        // Check if this is the 4th label in a group (4, 8, 12, 16, 20, etc.)
        // Add extra 0.3mm gap after every 4th label
        // Works for any quantity: 8, 10, 20, 50, 100+ labels
        bool addExtraGap = (i > 0 && (i + 1) % 4 == 0);
