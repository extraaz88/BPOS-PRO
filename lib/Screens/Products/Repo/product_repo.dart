...
class ProductRepo {
  ...
  Future<List<ProductModel>> fetchAllProducts() async {
    ...
    if (response.statusCode == 200) {
      ...
      // Include all products (both regular and combo products)
      // Combo products will be shown with different color in the UI
      ...
      print('Note: All products (including combos) are included in the list');
