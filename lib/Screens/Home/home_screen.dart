                ...
                children: [
                  ...
                  FutureBuilder<Map<String, String?>>(
                    ...
                    builder: (context, snapshot) {
                      if (snapshot.hasData) {
                        final displayCategory = snapshot.data!['original'] ??
                            snapshot.data!['mapped'];
                        if (displayCategory != null &&
                            displayCategory != 'All Category' &&
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            getLocalizedPrintText('Welcome back!'),
                            style: TextStyle(
                              color: Colors.white,
                              fontSize: 24,
                          ...
                          SizedBox(height: 8),
                          Text(
                            details.user?.name ?? getLocalizedPrintText('User'),
                            style: TextStyle(
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '$count ${getLocalizedPrintText('products are running low on stock')}',
                                            style: TextStyle(
                                              fontSize: 14,
                    ...
                    // Quick Actions Grid
                    Text(
                      getLocalizedPrintText('Quick Actions'),
                      style: TextStyle(
                        fontSize: 20,
                        fontWeight: FontWeight.bold,
                        color: kTitleColor,
  ...
  Future<List<Widget>> _buildQuickActionCards(WidgetRef ref) async {
    ...
    if (visibility[PermissionService.SALE_PERMISSION] == true &&
      ...
      cards.add(_buildQuickActionCard(
        ...
        title: getLocalizedPrintText('New Sale'),
        color: Colors.green,
        onTap: () {
          Navigator.push(
            context,
        ...
        showcaseDescription:
            getLocalizedPrintText('Create a new sale transaction here'),
      ));
    }
    ...
    if (visibility[PermissionService.PURCHASE_PERMISSION] == true &&
      ...
      cards.add(_buildQuickActionCard(
        ...
        title: getLocalizedPrintText('New Purchase'),
        color: Colors.blue,
        onTap: () {
          Navigator.push(
            context,
        ...
        showcaseDescription:
            getLocalizedPrintText('Create a new purchase transaction here'),
      ));
    }
    ...
    if (visibility[PermissionService.PARTIES_PERMISSION] == true &&
      ...
      cards.add(_buildQuickActionCard(
        icon: Icons.people,
        title: getLocalizedPrintText('Add Customer/Supplier'),
        color: Colors.orange,
        onTap: () async {
        ...
        showcaseDescription:
            getLocalizedPrintText('Add new customer or supplier here'),
      ));
    }
    ...
    if (visibility[PermissionService.PRODUCT_PERMISSION] == true &&
      ...
      cards.add(_buildQuickActionCard(
        ...
        title: getLocalizedPrintText('Add Product'),
        color: Colors.purple,
        onTap: () {
          Navigator.push(
            context,
        ...
        showcaseDescription:
            getLocalizedPrintText('Add a new product to your inventory'),
      ));
    }
    ...
    if (visibility[PermissionService.DASHBOARD_PERMISSION] == true &&
      ...
      cards.add(_buildQuickActionCard(
        ...
        title: getLocalizedPrintText('Dashboard'),
        color: Colors.red,
        onTap: () {
          Navigator.push(
            context,
        ...
        showcaseDescription:
            getLocalizedPrintText('View your business dashboard and analytics'),
      ));
    }
    ...
    if (visibility[PermissionService.REPORTS_PERMISSION] == true &&
      ...
      cards.add(_buildQuickActionCard(
        ...
        title: getLocalizedPrintText('Reports'),
        color: Colors.teal,
        onTap: () {
          Navigator.push(
            context,
        ...
        showcaseDescription:
            getLocalizedPrintText('View detailed business reports'),
      ));
    }
...
String getDayLeftInExpiring(
  ...
  if (expireDate == null) {
    return shortMSG
        ...
        : getLocalizedPrintText('Subscribe Now');
  }

  final expiringDay = DateTime.parse(expireDate);
  return shortMSG
      ? '${expiringDay.difference(DateTime.now()).inDays}\n${getLocalizedPrintText('Days Left')}'
      : '${expiringDay.difference(DateTime.now()).inDays} ${getLocalizedPrintText('Days Left')}';
}