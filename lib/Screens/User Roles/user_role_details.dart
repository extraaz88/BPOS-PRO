      ...
      return GlobalPopup(
        child: Scaffold(
          ...
          bottomNavigationBar: Padding(
            ...
            child: ElevatedButton(
                onPressed: (() async {
                  if (salePermission || partiesPermission || purchasePermission || productPermission || profileEditPermission || addExpensePermission || lossProfitPermission || dueListPermission || stockPermission || reportsPermission || salesListPermission || addIncomePermission || dashBoardPermission || purchaseListPermission) {
                    if (validateAndSave()) {
                      EasyLoading.show(
                        status: lang.S.of(context).loading,
                        //'loading..'
