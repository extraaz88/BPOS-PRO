...
class AddSalesScreenState extends ConsumerState<AddSalesScreen> {
  ...
  builder: (context2) {
    return DraggableScrollableSheet(
      ...
      maxChildSize: 0.95,    // 👈 maximum drag height
      builder: (context3, scrollController) {
        return SafeArea(
                            ...
                            onPressed: () async {
                              ...
                              try {
                                ...
                                final selectedProductList =
                                  ...
                                  final unitPrice =
                                      num.tryParse(element.unitPrice.toString()) ??
                                          0;
                                  ...
                                  if (element.gstRateSelect != null) {
                                    productTaxAmount = element.calculateGstAmount(
                                        providerData.selectedTaxType);
                                  }
                                  return CartSaleProducts(
                                    ...
                                    price: unitPrice,
                                    lossProfit: (element.quantity * unitPrice) -
                                ...
                                final summaryArguments = SaleBillSummaryArguments(
                                  ...
                                  isSplitPayment: isSplitPayment,
                                  splitPaymentAmounts:
                                      Map<int, double>.from(splitPaymentAmounts),
