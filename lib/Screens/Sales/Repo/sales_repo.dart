...
class CartSaleProducts {
  ...
  final bool? isComboProduct; // Flag to indicate if product is from combo
  ...
  Map<String, dynamic> toJson() {
    ...
    // Include is_combo_product flag if true
    if (isComboProduct == true) {
      json['is_combo_product'] = true;
      json['skip_stock_update'] = true; // Backend flag to skip stock update
    }
