      ...
      if (response.statusCode == 200) {
        ...
        try {
          await CurrencyMethods().saveCurrencyDataInLocalDatabase(
              selectedCurrencySymbol: responseData['data']['currency']
                  ['symbol'],
          ...
          if (responseData['data']['business_category_name'] != null) {
            try {
              final apiCategoryName =
                  responseData['data']['business_category_name'] as String;
              ...
              if (categoryData != null) {
                ...
                print(
                    'Mapped Category Name: $categoryName from API category: $apiCategoryName');
                ...
                print(
                    'Warning: Category data is null for API category: $apiCategoryName');
                // Navigate to shop category selection screen without preselection
                Navigator.pushReplacement(
                  context,
                  MaterialPageRoute(
                      builder: (context) =>
                          const ShopCategorySelectionScreen()),
                );
              }
            } catch (error) {
              ...
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                    builder: (context) => const ShopCategorySelectionScreen()),
              );
            }
          } else {
