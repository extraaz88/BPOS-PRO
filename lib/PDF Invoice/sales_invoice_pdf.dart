...
class SalesInvoicePdf {
  static Future<void> generateSaleDocument(
    ...
    // Retrieve GST and IFSC from SharedPreferences
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    final String gstNumber = prefs.getString("gst") ?? "";
    final String ifscCode = prefs.getString("ifsc") ?? "";
              ...
              decoration: const pw.BoxDecoration(
                gradient: pw.LinearGradient(
                  ...
                  colors: [
                    ...
                    PdfColor.fromInt(0xffBBDEFB), // Medium blue
                  ],
                ),
              ),
              child: pw.Padding(
                              ...
                              pw.SizedBox(
                                ...
                                child: getLocalizedPdfText(
                                    transactions.party?.phone ??
                                        (transactions.meta?.customerPhone ??
                                            _lang.guest),
                                    pw.TextStyle(
                                        font: getFont(),
                                        fontFallback: [englishFont])),
                      ...
                      pw.TableRow(
                        ...
                        children: [
                          ...
                          pw.Padding(
                            ...
                            child: getLocalizedPdfText(
                              (() {
                                final quantity = PDFCommonFunctions()
                                    .getProductQuantity(
                                        detailsId:
                                ...
                                final saleDetail =
                                    transactions.salesDetails![i];

                                // Try to get display unit from cart items
                                if (cartItems != null) {
                                  try {
                                    ...
                                    if (cartItem.unitName != null &&
                                        cartItem.unitName!.isNotEmpty) {
                                      return '${formatPointNumber(quantity)} ${cartItem.unitName}';
                                    }
                                  } catch (e) {
                                    // Cart item not found, continue
                                  }
                                }
                          ...
                          pw.Padding(
                            padding: const pw.EdgeInsets.all(8.0),
                            child: getLocalizedPdfText(
                              formatPointNumber(transactions.salesDetails!
                                      .elementAt(i)
                                      .price ??
                                  0),
                              textAlignment: pw.TextAlign.right,
                          ...
                          pw.Padding(
                            padding: const pw.EdgeInsets.all(8.0),
                            child: getLocalizedPdfText(
                              formatPointNumber((transactions
                                          .salesDetails![i].price ??
                                      0) *
                                  (PDFCommonFunctions().getProductQuantity(
                                      detailsId:
                                          transactions.salesDetails![i].id ?? 0,
                                      transactions: transactions))),
                              textAlignment: pw.TextAlign.right,
                              pw.TextStyle(
                                  font: getFont(), fontFallback: [englishFont]),
                  ...
                  children: [
                    pw.Column(
                      ...
                      children: [
                        ...
                        pw.SizedBox(height: 5.0),
                        getLocalizedPdfText(
                            "Service Charge: ${formatPointNumber(transactions.serviceCharge ?? 0.00)}",
                            pw.TextStyle(
                              color: PdfColors.black,
                              fontWeight: pw.FontWeight.bold,
                              font: getFont(),
                      ...
                      children: [
                        ...
                        pw.Container(
                          ...
                          child: pw.Row(
                            ...
                            children: [
                              pw.Text(
                                "${_lang.paidVia}: ${(transactions.isSplitPayment == true) ? 'Split' : (transactions.paymentType?.name ?? 'N/A')}",
                                style:
                            ...
                            children: [
                              ...
                              pw.Column(
                                ...
                                children: [
                                  ...
                                  if (transactions.isSplitPayment == true ||
                                      transactions.paymentType?.name != null)
                                    pw.Padding(
                                      padding:
                                          const pw.EdgeInsets.only(top: 5.0),
                                      child: pw.Text(
                                        "${_lang.paymentTypes}: ${(transactions.isSplitPayment == true) ? 'Split' : (transactions.paymentType?.name ?? 'N/A')}",
                                        style: pw.TextStyle(
                                          color: PdfColors.black,
                                          fontSize: 11,
