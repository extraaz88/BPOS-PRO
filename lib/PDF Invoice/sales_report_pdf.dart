...
class SalesReportPdf {
  static Future<void> generateSalesReport({
    ...
    final filteredTransactions = transactions.where((element) {
      final transactionDate = DateTime.parse(element.saleDate ?? '');
            ...
            children: [
              ...
              pw.TableRow(
                ...
                children: [
                  ...
                  _buildHeaderCell(_lang.customerName, getFont(), englishFont),
              ...
              for (int i = 0; i < filteredTransactions.length; i++)
                pw.TableRow(
                  ...
                  children: [
                    ...
                    _buildDataCell(
                      DateFormat.yMMMd().format(DateTime.parse(filteredTransactions[i].saleDate ?? '')),
                      getFont(),
                      englishFont,
                    ),
    ...
    await PDFCommonFunctions.savePdfAndShowPdf(
      ...
      invoice: 'SalesReport_${DateFormat('yyyyMMdd').format(fromDate)}_${DateFormat('yyyyMMdd').format(toDate)}',
      doc: doc,
      isShare: isShare,
    );
  }
